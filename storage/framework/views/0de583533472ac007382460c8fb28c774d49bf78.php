<?php $__env->startSection('content'); ?>
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active <?php echo e($pull); ?>"> <?php echo e(__('Profile')); ?></li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo e(__('Update Profile')); ?> : <?php echo e(Auth::User()->name); ?></h3>
            ...
            <form action="<?php echo e(URL::to('admin/profile/'.Auth::User()->id)); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="form-group row">
                                <label for="name[ar]" class="col-sm-3 col-form-label"><?php echo e(trans('admin.name')); ?></label>
                                <div class="col-sm-9">
                ...
                <div class="box-footer">
                    <button type="submit" class="btn btn-primary btn-lg"
                            style="font-size: 16px;"><?php echo e(__('Save')); ?></button>
                    <a href="<?php echo e(URL::to('admin')); ?>" class="btn btn-default btn-lg"
...
<?php echo $__env->make('admin.layouts.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Yosra\Documents\GitHub\taskk\resources\views/admin/profile/index.blade.php ENDPATH**/ ?>