...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item {{$pull}}"><a href="{{URL::to('admin/admins')}}"> {{__('Supervisors')}}</a></li>
            <li class="breadcrumb-item active {{$pull}}">{{__('Add supervisor')}}</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title">{{__('Add supervisor')}}</h3>
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    {!! Form::select('roles[]', $roles,null, array('class' => 'form-control select2','multiple','data-placeholder' => __('Choose Role'))) !!}
                                    @if($errors->has('roles'))
