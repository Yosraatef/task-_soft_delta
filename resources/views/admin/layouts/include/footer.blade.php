...
{{--$permission_orders_count = App\Models\Permission::where('group_id',Auth::User()->group_id)->where('permission','orders_all')->count(); --}}
{{--<input type="hidden" id="orders_notify" value="1">--}}
